...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private UserDetailsService jwtUserDetailsService; // Nossa implementação de UserDetailsService
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                .authorizeRequests()
                .antMatchers("/api/auth/login", "/api/auth/register").permitAll() // Permite acesso sem autenticação
